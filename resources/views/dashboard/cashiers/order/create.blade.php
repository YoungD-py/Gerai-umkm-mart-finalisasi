                                            ...
                                            <tr id="order-row-{{ $order->id }}">
                                                ...
                                                <td class="py-3 text-center">
                                                    <div class="qty-controls">
                                                        <button type="button" class="qty-btn btn btn-danger btn-sm" onclick="updateQty({{ $order->id }}, {{ $order->qty - 1 }})" {{ $order->qty <= 1 ? 'disabled' : '' }}>
                                                            <i class="bi bi-dash"></i>
                                                        </button>
                                                        <span class="qty-display badge bg-secondary fs-6" id="qty-{{ $order->id }}">{{ $order->qty }}</span>
                                                        <button type="button" class="qty-btn btn btn-success btn-sm" onclick="updateQty({{ $order->id }}, {{ $order->qty + 1 }})">
                                                            <i class="bi bi-plus"></i>
                                                        </button>
                                                    </div>
                                                </td>
                                                <td class="py-3 text-end px-3 fw-bold text-success" id="subtotal-{{ $order->id }}">
                    ...
                    <div class="card shadow-sm border-0 mt-4" id="tebus-murah-card" style="background: white;">
                        <div class="card-header text-white py-3" style="background: linear-gradient(45deg, #dc3545, #e74c3c);">
                            <h4 class="mb-0 fw-bold">
                                ...
                                <span class="badge bg-light text-dark ms-2 fs-6">{{ $tebusMusahProducts->count() }}</span>
                            </h4>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        @foreach($tebusMusahProducts as $product)
                                            @php
                                            ...
                                            <tr class="tebus-murah-item">
                                                <td class="py-3 px-3">
                                                    ...
                                                    <small class="text-muted">Stok: {{ $product->stok }} pcs</small>
                                                    <br><span class="tebus-murah-badge">TEBUS MURAH</span>
                                                </td>
                                                <td class="py-3 text-center">
                                                    <div class="fw-bold text-danger fs-5">
                                                        Rp {{ number_format($product->harga_tebus_murah, 0, ',', '.') }}
                                                    </div>

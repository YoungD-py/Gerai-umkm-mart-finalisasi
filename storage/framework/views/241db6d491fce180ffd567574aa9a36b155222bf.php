...
<script>
  document.addEventListener('DOMContentLoaded', function() {
      ...
      // [BARU] Logika untuk semua tombol sort (expired, tgl_masuk, stok, harga)
      const sortToggles = document.querySelectorAll('.sort-toggle');
      sortToggles.forEach(toggleButton => {
          toggleButton.addEventListener('click', function() {
              const sortParam = this.dataset.sortParam; // e.g., 'expired', 'tgl_masuk', 'stok', 'harga'
              ...
              // Clear all existing sort parameters first
              ...
              // Set the new sort parameter if not 'none'
              if (newSortOrder !== 'none') {
                  url.searchParams.set(`sort_${sortParam}`, newSortOrder);
              }

              // Preserve existing search and category filter parameters
              ...
              if (categoryFilter !== 'all') {
                  url.searchParams.set('category_id', categoryFilter);
              } else {
      ...
      if (categoryFilterSelect) {
          categoryFilterSelect.addEventListener('change', function() {
              ...
              // Clear all sort parameters when changing category filter (optional, depends on UX)
              url.searchParams.delete('sort_expired');
              url.searchParams.delete('sort_tgl_masuk');
              url.searchParams.delete('sort_stok');
              url.searchParams.delete('sort_harga');

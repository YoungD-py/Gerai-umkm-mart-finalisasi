...
<head>
    ...
    <title>Login Admin - UMKM MART</title>
    ...
    <style>
        ...
        .login-header .logo {
            ...
            height: 48px;
            margin-bottom: 1rem;
            color: #d63939; /* Warna merah untuk admin */
        }
        .login-header h1 {
            font-size: 1.5rem;
            font-weight: 600;
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php $__errorArgs = ['captcha_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php /**PATH D:\SEMESTER 6\KERJA PRAKTEK PELINDO\project umkm\NEW\kasirku-main\resources\views/admin-login.blade.php ENDPATH**/ ?>
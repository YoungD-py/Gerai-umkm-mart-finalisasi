...
<html>
<head>
    <title>Cetak Nota - <?php echo e($transaction->first()->no_nota); ?></title>
    <meta charset="utf-8">
    ...
    <table class="main-table">
        ...
        <tr>
            <td colspan="4" class="barcode-section">
                ...
                <div class="barcode-container">
                    <svg id="barcode-<?php echo e($trans->no_nota); ?>" width="150" height="40"></svg>
                    <div class="barcode-text"><?php echo e($shortBarcode); ?></div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </td>
        </tr>
        ...
        <tr>
             <td colspan="4" style="padding-top: 10px;">
                ...
                <div class="text-center" style="font-size: 9px; padding-top: 5px; font-weight: bold;"><?php echo e(date('d/m/Y H:i:s')); ?></div>
             </td>
        </tr>
    </table>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php
                ...
                $shortBarcode = (count($notaParts) >= 3) ? $notaParts[1] . '-' . $notaParts[2] : $trans->no_nota;
            ?>
            JsBarcode("#barcode-<?php echo e($trans->no_nota); ?>", "<?php echo e($shortBarcode); ?>", {
                format: "CODE128",
                width: 1,
                height: 40,
                displayValue: false,
...
<?php /**PATH /var/www/resources/views/nota_print.blade.php ENDPATH**/ ?>
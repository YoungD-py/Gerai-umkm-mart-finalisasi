...
unset($__errorArgs, $__bag); ?>" id="role" name="role" required>
                                    ...
                                    <option value="MANAJER" <?php echo e(old('role', $user->role) == 'MANAJER' ? 'selected' : ''); ?>>Manajer</option>
                                </select>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kuliah\Magang Pelindo\project\Gerai-umkm-mart-finalisasi\resources\views/dashboard/users/edit.blade.php ENDPATH**/ ?>
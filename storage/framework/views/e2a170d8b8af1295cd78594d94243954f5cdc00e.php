```html
    ...
    <body>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="<?php echo e($item['status'] == 'DEBET' ? 'status-debet' : 'status-credit'); ?>">
                        <?php echo e($item['status']); ?>

                    </td>
                    <td class="currency">Rp <?php echo e(number_format($item['nominal'], 0, ',', '.')); ?></td>
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td class="currency status-credit">Rp <?php echo e(number_format($totalCredit, 0, ',', '.')); ?></td>
                    </tr>
                    <tr>
                        <td>Total Pengeluaran (DEBET)</td>
                        <td class="currency status-debet">Rp <?php echo e(number_format($totalDebit, 0, ',', '.')); ?></td>
                    </tr>
                    <tr class="total-row">
                        <td>Saldo Akhir</td>
                        <td class="currency">Rp <?php echo e(number_format($saldoAkhir, 0, ',', '.')); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="footer">
            <p>Laporan ini digenerate secara otomatis pada <?php echo e($generated_at->format('d F Y H:i:s')); ?></p>
            <p><strong>GERAI UMKM MART - Sistem Manajemen Keuangan</strong></p>
        </div>
    </body>
    </html><?php /**PATH D:\SEMESTER 6\KERJA PRAKTEK PELINDO\project umkm\NEW\kasirku-main\resources\views/laporan_keuangan_pdf.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>" name="category_id" id="category_id" required>
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>" <?php echo e(old('category_id', $good->category_id) == $category->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="tgl_masuk" name="tgl_masuk" value="<?php echo e(old('tgl_masuk', $good->tgl_masuk->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="nama" name="nama" value="<?php echo e(old('nama', $good->nama)); ?>" required autofocus placeholder="Masukkan nama barang...">
...
unset($__errorArgs, $__bag); ?>" name="type" id="type" required onchange="toggleExpiredField(); calculateSellingPrice();">
                                    ...
                                    <option value="makanan" <?php echo e(old('type', $good->type) == 'makanan' ? 'selected' : ''); ?>>Makanan & Minuman</option>
                                    <option value="non_makanan" <?php echo e(old('type', $good->type) == 'non_makanan' ? 'selected' : ''); ?>>Non Makanan & Minuman</option>
                                    <option value="lainnya" <?php echo e(old('type', $good->type) == 'lainnya' ? 'selected' : ''); ?>>Lainnya</option>
...
unset($__errorArgs, $__bag); ?>" id="expired_date" name="expired_date" value="<?php echo e(old('expired_date', $good->expired_date ? $good->expired_date->format('Y-m-d') : '')); ?>" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>">
...
unset($__errorArgs, $__bag); ?>" id="harga_asli" name="harga_asli" value="<?php echo e(old('harga_asli', $good->harga_asli)); ?>" required min="0" onchange="calculateSellingPrice();" oninput="calculateSellingPrice();">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="stok" name="stok" value="<?php echo e($good->stok); ?>" readonly>
                                    ...
                                    <div class="stock-readonly-info">
                                        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center gap-2">
                                            ...
                                            <a href="/dashboard/restock/<?php echo e($good->id); ?>/edit" class="btn-info-restock w-100 w-sm-auto"><i class="bi bi-plus-circle"></i> Restock</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>" id="markup_percentage" name="markup_percentage" value="<?php echo e(old('markup_percentage', $good->markup_percentage)); ?>" min="0" max="100" step="0.01" placeholder="Contoh: 5 (untuk 5%)" oninput="calculateSellingPrice();">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p class="mb-1"><strong>Markup:</strong> <span id="markup-percent" class="text-info">
                                            <?php if($good->markup_percentage !== null): ?>
                                                <?php echo e(number_format($good->markup_percentage, 0)); ?>% (Manual)
                                            <?php else: ?>
                                                <?php echo e($good->type === 'makanan' ? '2%' : '5%'); ?> (Otomatis)
                                            <?php endif; ?>
                                        </span></p>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <p class="mb-0"><strong>Selisih:</strong> <span id="display-profit" class="text-success">Rp <?php echo e(number_format(($good->harga ?? 0) - ($good->harga_asli ?? 0), 0, ',', '.')); ?></span></p> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wholesale-section">
                            ...
                            <div class="wholesale-toggle">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="is_grosir_active" name="is_grosir_active" value="1" <?php echo e(old('is_grosir_active', $good->is_grosir_active) ? 'checked' : ''); ?> onchange="toggleWholesaleFields()">
...
unset($__errorArgs, $__bag); ?>" id="min_qty_grosir" name="min_qty_grosir" value="<?php echo e(old('min_qty_grosir', $good->min_qty_grosir)); ?>" min="2" placeholder="Contoh: 10">
                                            <span class="input-group-text">unit</span>
                                        </div>
...
unset($__errorArgs, $__bag); ?>" id="harga_grosir" name="harga_grosir" value="<?php echo e(old('harga_grosir', $good->harga_grosir)); ?>" min="0" placeholder="Harga lebih murah dari harga eceran">
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="tebus-murah-section">
                            ...
                            <div class="tebus-murah-toggle">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="is_tebus_murah_active" name="is_tebus_murah_active" value="1" <?php echo e(old('is_tebus_murah_active', $good->is_tebus_murah_active) ? 'checked' : ''); ?> onchange="toggleTebusMusahFields()" style="background-color: #dc3545; border-color: #dc3545;">
...
unset($__errorArgs, $__bag); ?>" id="min_total_tebus_murah" name="min_total_tebus_murah" value="<?php echo e(old('min_total_tebus_murah', $good->min_total_tebus_murah)); ?>" min="0" placeholder="Contoh: 100000">
                                        </div>
...
unset($__errorArgs, $__bag); ?>" id="harga_tebus_murah" name="harga_tebus_murah" value="<?php echo e(old('harga_tebus_murah', $good->harga_tebus_murah)); ?>" min="0" placeholder="Harga lebih murah dari harga normal">
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="barcode-info">
                                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center gap-3">
                                    ...
                                    <div class="d-grid d-sm-flex gap-2 w-100 w-sm-auto">
                                        <a href="/dashboard/goods/<?php echo e($good->id); ?>/print-barcode" class="btn-outline-umkm"><i class="bi bi-printer"></i> Print / Download</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alert-warning-umkm">
                            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center gap-3">
                                ...
                                <a href="/dashboard/goods/<?php echo e($good->id); ?>/generate-barcode" class="btn-warning-umkm w-100 w-sm-auto"><i class="bi bi-qr-code"></i> Generate Barcode</a>
                            </div>
                        </div>
                        <?php endif; ?>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Repo_Git\Gerai-umkm-mart-finalisasi\resources\views/dashboard/goods/edit.blade.php ENDPATH**/ ?>
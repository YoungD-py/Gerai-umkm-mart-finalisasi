        ...
        <div class="umkm-card-body">
            ...
            <form action="<?php echo e(route('goods.cetakbarcode.pdf')); ?>" method="POST" id="barcodePrintForm" onsubmit="handleFormSubmit(this)">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button type="submit" class="btn-umkm" id="printButton" disabled>
                    ...
                    <table class="table table-umkm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($good->barcode ?? '-'); ?></td>
                                <td>Rp. <?php echo e(number_format($good->harga, 0, ',', '.')); ?></td>
                                <td><?php echo e($good->stok); ?> unit</td>
                            </tr>
...
function handleFormSubmit(form) {
    ...
    if (button && !button.disabled) { // Hanya jalankan jika tombol tidak di-disable
        ...
        setTimeout(function() {
            ...
            // Panggil fungsi update lagi untuk memastikan status disabled-nya benar
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateSelectAllState() {
        const visibleEnabledCheckboxes = document.querySelectorAll('.good-checkbox:not(:disabled):not([style*="display: none"])');
        const checkedVisibleEnabledCheckboxes = document.querySelectorAll('.good-checkbox:checked:not(:disabled):not([style*="display: none"])');

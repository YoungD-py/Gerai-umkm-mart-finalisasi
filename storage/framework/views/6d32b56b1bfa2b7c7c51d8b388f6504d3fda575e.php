                ...
                <div class="umkm-card-body">
                    <form method="post" action="/dashboard/transactions/<?php echo e($transaction->id); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="user_id" disabled>
                                ...
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <option value="<?php echo e($user->id); ?>" <?php echo e((old('user_id', $transaction->user_id) == $user->id) ? 'selected' : ''); ?>>
                                        <?php echo e($user->nama ?? 'Nama tidak tersedia'); ?>
                            ...
                            <small class="text-muted d-block mt-1">
                                <i class="bi bi-info-circle-fill"></i> Administrator saat ini: <?php echo e($transaction->user->nama ?? 'User tidak ditemukan'); ?>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/dashboard/transactions/edit.blade.php ENDPATH**/ ?>